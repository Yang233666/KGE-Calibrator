...
def parse_args(args=None):
	...
	parser.add_argument('-save', '--save_path', default='../models/ComplEx_FB15k', type=str)
	parser.add_argument('-init', '--init_checkpoint', default='../models/ComplEx_FB15k', type=str)
