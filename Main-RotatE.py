...
def parse_args(args=None):
	...
	parser.add_argument('-save', '--save_path', default='../models/RotatE_wn18rr', type=str)
	parser.add_argument('-init', '--init_checkpoint', default='../models/RotatE_wn18rr', type=str)
	...
	parser.add_argument('--valid_batch_size', default=5, type=int, help='valid batch size')
	parser.add_argument('--uni_weight', action='store_true', default=True,
	...
	if args.do_train:
		...
		for step in range(init_step, args.max_steps):
			...
			if args.do_valid and step % args.valid_steps == 0:
				...
				metrics = kge_model.test_step(kge_model, valid_triples, all_true_triples, args, calibration_models_list)
